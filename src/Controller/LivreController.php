...
class LivreController extends AbstractController
{
    ...
    public function index(LivreRepository $livreRepository, GenreRepository $genreRepository,
        AuteurRepository $auteurRepository): Response
    {
    ...
    */
    ...
    #[Route('/livre/liste-par-note/{note}', name: 'livre_liste_par_note', methods: ['GET'])]
    ...
    #[Route('/livre/liste-par-date/{date}', name: 'livre_liste_par_date', methods: ['GET'])]
    ...
    #[Route('/livre/liste-par-auteur/{auteur}', name: 'livre_liste_par_auteur', methods: ['GET'])]
    ...
    #[Route('/livre/liste-par-genre/{genre}', name: 'livre_liste_par_genre', methods: ['GET'])]
